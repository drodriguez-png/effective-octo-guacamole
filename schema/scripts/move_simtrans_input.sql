...
-- show results
update HIISQLSERV5.SNDBase91.dbo.TransAct set TransType='SN90' where TransType = 'SN91A' and District=3;
update HIISQLSERV5.SNDBase91.dbo.TransAct set ErrorTag=0 where TransId like 'unit%';
